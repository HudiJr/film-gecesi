...
// Sayfa açıldığında LocalStorage kontrolü (Kalıcı Profil)
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedUser) {
        ...
        currentAvatar = savedAvatar || 'https://via.placeholder.com/150';
        
        // Doğrudan oda kurma / katılma ekranına geç
...
authLoginBtn.addEventListener('click', () => {
    ...
    const avatar = authAvatar.value.trim() || 'https://via.placeholder.com/150';
...
editProfileBtn.addEventListener('click', () => {
    ...
    authAvatar.value = currentAvatar;
});
...
// Google Modalı (e-Devlet, TikTok vb. siteler için)
