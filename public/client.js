...
// Gelen Aramalar (Kamera ve Ekran Paylaşımı Çağrıları)
peer.on('call', (call) => {
    call.answer(localStream);
    call.on('stream', (remoteStream) => {
        // Eğer gelen çağrı ekran paylaşımı etiketi taşıyorsa veya video boyutları büyükse ana oynatıcıya ver
...
function connectToNewUser(peerId, username, stream) {
    ...
    // Eğer o an bilgisayarda ekran paylaşıyorsak, yeni katılan kullanıcıya ekran yayınını da atayalım
    if (screenStream) {
...
// Ekran Paylaşımı (WebRTC Yayın Entegrasyonu)
shareScreenBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        // Odadaki herkese ekran yayınını PeerJS ile gönder
