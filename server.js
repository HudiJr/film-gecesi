...
const rooms = {};
// Kullanıcıların şifreleri, arkadaş listeleri, istekleri ve DM geçmişlerini tutan hafıza tabanı
const usersDB = {}; 

io.on('connection', (socket) => {
    sendRoomList();

    // Kullanıcı Giriş / Kayıt İşlemi (Şifreli ve Kalıcı)
    ...
    // YouTube, Medya ve Senkronizasyon Olayları
